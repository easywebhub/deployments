define(["require", "exports"], function (require, exports) {
    ...
    var BootstrapFormRendererSwal = (function () {
        function BootstrapFormRendererSwal() {
        }
        BootstrapFormRendererSwal.prototype.render = function (instruction) {
            for (var _i = 0, _a = instruction.unrender; _i < _a.length; _i++) {
                var _b = _a[_i], error = _b.error, elements = _b.elements;
                for (var _c = 0, elements_3 = elements; _c < elements_3.length; _c++) {
                    var element_3 = elements_3[_c];
                    this.remove(element_3, error);
                }
            }
            for (var _d = 0, _e = instruction.render; _d < _e.length; _d++) {
                var _f = _e[_d], error = _f.error, elements = _f.elements;
                for (var _g = 0, elements_4 = elements; _g < elements_4.length; _g++) {
                    var element_4 = elements_4[_g];
                    this.add(element_4, error);
                }
            }
        };
        BootstrapFormRendererSwal.prototype.add = function (element, error) {
            var formGroup = element.closest('.form-group');
            if (!formGroup) {
                return;
            }
        ...
        BootstrapFormRendererSwal.prototype.remove = function (element, error) {
            var formGroup = element.closest('.form-group');
            if (!formGroup) {
                return;
            }
        ...
        return BootstrapFormRendererSwal;
    }());
    exports.BootstrapFormRendererSwal = BootstrapFormRendererSwal;
});

//# sourceMappingURL=bootstrap-form-render.js.map
