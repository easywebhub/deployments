...
define(["require", "exports", 'aurelia-dialog', 'aurelia-dependency-injection', '../../../services/Action/ActionInCampaignService'], function (require, exports, aurelia_dialog_1, aurelia_dependency_injection_1, ActionInCampaignService_1) {
    "use strict";
    var ActionInCamPaignDeleteDlg = (function () {
        function ActionInCamPaignDeleteDlg(dialogController, actionInCampaignService) {
            this.actionInCampaignService = actionInCampaignService;
            this.dialogController = dialogController;
        }
        ActionInCamPaignDeleteDlg.prototype.activate = function (data) {
            this.deleteAction = data;
            console.log('data', JSON.stringify(data));
        };
        ActionInCamPaignDeleteDlg.prototype.delete = function (deleteAction) {
            this.dialogController.ok(deleteAction);
        };
        ActionInCamPaignDeleteDlg = __decorate([
        ...
        ], ActionInCamPaignDeleteDlg);
        return ActionInCamPaignDeleteDlg;
    }());
    exports.ActionInCamPaignDeleteDlg = ActionInCamPaignDeleteDlg;
});

//# sourceMappingURL=ActionInCampaignDeleteDlg.js.map
