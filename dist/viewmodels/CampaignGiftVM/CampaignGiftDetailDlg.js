...
define(["require", "exports", 'aurelia-dialog', '../../services/CampaignGift/CampaignGiftService', 'aurelia-router', 'aurelia-dependency-injection'], function (require, exports, aurelia_dialog_1, CampaignGiftService_1, aurelia_router_1, aurelia_dependency_injection_1) {
    "use strict";
    var CampaignGiftDetailDlg = (function () {
        function CampaignGiftDetailDlg(dialogController, campaignGiftService, router, validationController) {
            this.campaignGiftService = campaignGiftService;
            this.router = router;
            this.dialogController = dialogController;
        }
        CampaignGiftDetailDlg.prototype.activate = function (data) {
            var _this = this;
            return Promise.all([data]).then(function (rs) {
                _this.detailCampaignGift = rs[0];
            });
        };
        CampaignGiftDetailDlg = __decorate([
        ...
        ], CampaignGiftDetailDlg);
        return CampaignGiftDetailDlg;
    }());
    exports.CampaignGiftDetailDlg = CampaignGiftDetailDlg;
});

//# sourceMappingURL=CampaignGiftDetailDlg.js.map
