...
define(["require", "exports", 'aurelia-framework', 'aurelia-fetch-client', '../..//services/HttpService'], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1, HttpService_1) {
    ...
    var LoggingServices = (function () {
        ...
        LoggingServices.prototype.CheckLogin = function (meta) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this.http.fetch("auth/signin", {
                    method: 'post',
        ...
        LoggingServices.prototype.SignUp = function (meta) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this.http.fetch("auth/signup", {
                    method: 'post',
                    body: aurelia_fetch_client_1.json(meta),
                })
                    .then(function (response) { return response.json(); })
